...
def check_files():
    settings = {"DELAY" : 300}
    default = ["in the Farplane", "LoveBeat", "Final Fantasy", "with himself", "Blitzball", "in a random battle", "love games", "HuniePop", "Yandere Sim", "with your heart", "hard to get", "on the junglegyms", "on the T walls", "a dirty saboteur", "with The Entity, "Kissing Simulator", "with the Pig King", "hooky", "Dead by Daylight", "vidjagaems", "with your butt", "on Coldwind Farm", "in the Asylum", "infinites", "as the bully"]
